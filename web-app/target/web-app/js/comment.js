...
$('#btn-comment').click(function () {
    ...
    var fitScore = $('#fit-score').val();
    var sellerScore = $('#seller-score').val();
    var logisticScore = $('#logistics-score').val();
    var goodsComment = $('#goods-comment').val();
    var serviceComment = $('#service-comment').val();
