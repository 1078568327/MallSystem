...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/myOrder_cancelOrder.css">
    ...
    <div class="order-right f-r">
        <div class="order-hd">
            ...
            <div class="ord-dai f-l">
                ...
                <p><a href="pri/usr/toCancelOrder" style="color: green">已取消订单</a><span>${requestScope.cancelOrder}</span></p>
            </div>
            <div style="clear:both;"></div>
        </div>
        <div class="order-md">
            ...
            <div class="md-info">
                <div class="dai">
                    <span style="margin-left: 15px;color: red;font-size: 16px;"><strong>已取消的订单</strong></span>
                </div>
                    ...
                    <div class="dai-con">
                        ...
                        <div class="dai-right f-l">
                            ...
                            <p class="d-r-p4">
                                ...
                                <a href="pri/usr/deleteCancelOrder?token=${requestScope.token}&orderId=${item.id}">删除订单</a><br/>
...
<script type="text/javascript" src="js/myOrder_cancelOrder.js"></script>
</body>
</html>
