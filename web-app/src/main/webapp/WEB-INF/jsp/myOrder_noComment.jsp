...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="css/myOrder_noComment.css">
    ...
    <div class="order-right f-r">
        <div class="order-hd">
            ...
            <div class="ord-dai f-l">
                ...
                <p><a href="pri/usr/noCommentOrder" style="color: green">待评价</a><span>${requestScope.waitForComment}</span></p>
        ...
        <div class="order-md">
            ...
            <div class="md-info">
                <div class="dai">
                    <span style="margin-left: 15px;color: red;font-size: 16px;"><strong>待评价</strong></span>
                </div>
...
<script type="text/javascript" src="js/myOrder_noComment.js"></script>
</body>
</html>
